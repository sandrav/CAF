...
/*
	CCF PGP Plugin
*/
if (!class_exists('ccfpgpDefaultDB')) {
	class ccfpgpDefaultDB extends ccfpgpDB {
	
		function ccfpgpDefaultDB($insert_default_content = true) {
		...
		function insertDefaultContent($overwrite = false) {
			...
			$name_field = array('field_slug' => $field_slugs['name'], 'field_label' => __('Your Name:', 'ccf-pgp'),
			'field_required' => 1, 'field_instructions' => __('Please enter your full name.', 'ccf-pgp'),
			'field_maxlength' => '100', 'field_type' => 'Text');
			$date_field = array('field_slug' => $field_slugs['date'], 'field_label' => __('When Should I Contact You:', 'ccf-pgp'),
			'field_required' => 0, 'field_instructions' => __('Please choose a date you would like to be contacted.', 'ccf-pgp'),
			'field_maxlength' => '100', 'field_type' => 'Date');
			$message_field = array('field_slug' => $field_slugs['message'], 'field_label' => __('Your Message:', 'ccf-pgp'),
			'field_required' => 0, 'field_instructions' => __('Enter any message or comment.', 'ccf-pgp'),
			'field_maxlength' => 0, 'field_type' => 'Textarea');
			$phone_field = array('field_slug' => $field_slugs['phone'], 'field_label' => __('Your Phone Number:', 'ccf-pgp'),
			'field_required' => 0, 'field_instructions' => __('Please enter your phone number.', 'ccf-pgp'),
			'field_maxlength' => 30, 'field_type' => 'Text');
			$google_field = array('field_slug' => $field_slugs['google'], 'field_label' => __('Did you find my website through Google?', 'ccf-pgp'),
			'field_required' => 0, 'field_instructions' => __('If you found my website through Google, check this box.', 'ccf-pgp'),
			'field_maxlength' => 0, 'field_type' => 'Checkbox', 'field_value' => __('Yes', 'ccf-pgp'));
			$contact_method_field = array('field_slug' => $field_slugs['contact_method'], 'field_label' => __('How should we contact you?', 'ccf-pgp'),
			'field_required' => 1, 'field_instructions' => __('By which method we should contact you?', 'ccf-pgp'),
			...
			$pleaseselect_option = array('option_slug' => $option_slugs['pleaseselect'], 'option_dead' => 1, 'option_label' => __('Please Select:', 'ccf-pgp'));
			$email_option = array('option_slug' => $option_slugs['email'], 'option_label' => __('By Email', 'ccf-pgp'));
			$phone_option = array('option_slug' => $option_slugs['phone'], 'option_label' => __('By Phone', 'ccf-pgp'));
			$nocontact_option = array('option_slug' => $option_slugs['nocontact'], 'option_label' => __('Do Not Contact Me', 'ccf-pgp'));
			$yes_option = array('option_slug' => $option_slugs['yes'], 'option_label' => __('Yes, I did.', 'ccf-pgp'));
			$contact_form = array('form_slug' => $form_slugs['contact_form'], 'form_title' => __('Contact Form', 'ccf-pgp'), 'form_method' => 'Post',
			'submit_button_text' => __('Send Message', 'ccf-pgp'), 'form_email' => get_option('admin_email'), 'form_success_message' => __('Thank you for filling out our contact form. We will be contacting you very soon.', 'ccf-pgp'),
			'form_success_title' => __('Thank You!', 'ccf-pgp'), 'form_access' => parent::getRolesArray(), 'form_style' => 0);
