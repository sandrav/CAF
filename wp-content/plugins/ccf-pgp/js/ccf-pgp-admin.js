$j(document).ready(function(){
	...
	$j("#ccfpgp-admin #create-fields .field-type-selector").change(function () {
		$j("#ccfpgp-admin #create-fields .field-type-selector option:selected").each(function () {
			if ($j(this).text() == "File") {
				$j("#ccfpgp-admin #create-fields .file-fields").fadeIn("slow");
			} else {
				$j("#ccfpgp-admin #create-fields .file-fields").hide();	
			}
		});
	}).trigger('change');

	var $tabs = $j( "#ccfpgp-admin #ccf-tabs" ).tabs();
